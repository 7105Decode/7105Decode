...
public class SixBallAutoRedSide extends LinearOpMode {
    ...
    public static double firsty = 35, firstx = 101, secondx = 132, secondy = 35, thirdx = 109, thirdy = 100, fourthx = 123.8, fourthy = 73.7, fifthx = 133.5, fifthy = 24.8, sixthx = 135.1, sixthy = 10.1, seventhx = 86.1, seventhy = 8.2;
