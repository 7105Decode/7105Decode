    ...
    public Command runRobot() {
        return new SequentialGroup(
                ...
                new ParallelGroup(new RunShooter(.865,-2280),
                        new FishForAprilTagRedAuto(1,false,.33,-2.5,1.5),
                ...
                new FishForAprilTagRedAuto(1,false,.3,-2.5,1.5),
                new FishForAprilTagRedAuto(1,true,.3,-2.5,1.5),
              ...
              new ParallelGroup(new FollowPath(DriveTrain.INSTANCE,paths.SixPark),
                new TurnShooterOff(),
                ...
                new FishForAprilTagRedAuto(1,false,0,-1.6,1.5),
                ...
                new MoveTransfer(Transfer.INSTANCE,true,false,false,Transfer.rightdownpos,.45),
                new MoveTransfer(Transfer.INSTANCE,false,false,true, midreadytransferpos,.9),
                new MoveTransfer(Transfer.INSTANCE,false,false,true, middownpos,.9));
    }
    @Override
    public void onInit() {
