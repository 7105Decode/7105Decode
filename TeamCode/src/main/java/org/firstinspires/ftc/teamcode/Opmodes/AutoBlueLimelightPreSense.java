...
@Autonomous
public class AutoBlueLimelightPreSense extends LinearOpMode {
    Follower follower;
...
//        List<AprilTagDetection> currentDetections = aprilTag.getDetections();
        ...
        while (opModeIsActive()){
            ...
            if (timer.seconds()<1.2){
                topturret.setPower(pid.calculate(205,topturret.getCurrentPosition()));
                ...
                follower.setTeleOpDrive(.18, .3, 0);
