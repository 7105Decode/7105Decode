...
public class BlueLongAuto extends NextFTCOpMode {
    public BlueLongAuto() {
    ...
    public Command runRobot() {
        return new SequentialGroup(
                ...
                new ParallelGroup(new RunShooter(.865,-2280),
                        new FishForAprilTagBlueAuto(2,true,.33,Turret.blueOffset,1.5),
                ...
                new ParallelGroup(new FollowPath(DriveTrain.INSTANCE,paths.ReturnToShoot),
                        ...
                        new Delay(.5).then(new MoveTransfer(Transfer.INSTANCE,false,false,true, midfurtherback,.3)).then(new ArtifactShaker())),
                new FishForAprilTagBlueAuto(2,true,.3,2,.7),
                new FishForAprilTagBlueAuto(2,false,.3,2,.7),
                ...
                new MoveTransfer(Transfer.INSTANCE,true,false,false,Transfer.rightdownpos,.45),
                new MoveTransfer(Transfer.INSTANCE,false,false,true, midreadytransferpos,.9),
//                new FollowPath(DriveTrain.INSTANCE,paths.GrabLine),
                ...
                new MoveTransfer(Transfer.INSTANCE,true,false,false,Transfer.rightdownpos,.45),
                new MoveTransfer(Transfer.INSTANCE,false,false,true, midreadytransferpos,.9),
                new FollowPath(DriveTrain.INSTANCE,paths.NinePark)
