...
public class TeleBlueBetter extends LinearOpMode {
    ...
    public static double loopTime,ty = 0,uppower = .4,holdpower = .08,transferthreshold = 1,leftvel = 0, lpadpos=.274,rpadppos=0.265,targetvel = -2280,hoodup = .965, hooddown = 0.055,shooterspeed = 0, lefttransferservopos = 0.085, midtransferservopos = 0.095,righttransferservopos = 0.115;
    @Override
